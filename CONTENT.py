...
def main(data_sets):
    ...
    try:
        for epoch in range(num_epochs):
            ...
            np.save("C:/Kirti/MS DS/DLH/prj/theta_with_rnnvec/thetas_train"+str(epoch),thetas_train)
            ...
            np.save("C:/Kirti/MS DS/DLH/prj/CONTENT_results/testlabels_"+str(epoch),new_testlabels)
